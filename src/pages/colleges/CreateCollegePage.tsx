...
export default function CreateCollegePage() {
  ...
  const saveCollege = (e: any) => {
    e.preventDefault();
    setIsSubmitting(true);

    CLIENT.post("colleges", { name, description })
      .then(() => {
        setName("");
        setDescription("");
    ...
    <div className="h-screen flex justify-center items-start">
      <div className="w-3/4">
        <div className="flex border-b justify-between items-center p-3">
          <h1 className="text-3xl font-bold">Create College</h1>
          <Link
            to="/"
        ...
        <form onSubmit={saveCollege} className="w-full mt-4">
          {/* Name */}
